from utils.models.open_router.config import get_smart_openrouter_model, get_fast_openrouter_model
from utils.models.groq.config import get_smart_groq_model, get_fast_groq_model
